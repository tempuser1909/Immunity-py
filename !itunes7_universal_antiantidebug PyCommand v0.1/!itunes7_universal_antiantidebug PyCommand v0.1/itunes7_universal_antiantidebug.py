#!/usr/bin/env python
"""
Universal hook after iTunes.checkForDebuggers() returns
...
This PyScript will scan the process address space, looking for the
likely location to hook; just after iTunes.checkForDebuggers() returns.
"""
