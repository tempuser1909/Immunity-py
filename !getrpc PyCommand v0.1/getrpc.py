...
Additional feature of iterating through all DLL's added by Justin Seitz <jms@bughunter.ca> if the script 
is broken, it's most likely my fault :)
"""
    ...
    while 1:
        ...
        try:
            ...
            if length == 0x44:
                ...
                imm.Log("RPC SERVER INTERFACE find at: 0x%08x" % addr, address = addr)
